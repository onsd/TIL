...
module DE10_LITE_Qsys_mm_interconnect_0 (
		...
		output wire [2:0]  hex_s1_address,                                             //                                               hex_s1.address
	...
	wire  [104:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> sw_s1_agent:cp_data
	...
	wire          cmd_mux_009_src_valid;                                                              // cmd_mux_009:src_valid -> hex_s1_agent:cp_valid
	wire  [104:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> hex_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                              // hex_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [10:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> hex_s1_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                                      // cmd_mux_009:src_startofpacket -> hex_s1_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                        // cmd_mux_009:src_endofpacket -> hex_s1_agent:cp_endofpacket
	...
	wire  [104:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> ledr_s1_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                              // ledr_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [10:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> ledr_s1_agent:cp_channel
	...
	wire  [104:0] sw_s1_agent_rp_data;                                                                // sw_s1_agent:rp_data -> router_010:sink_data
	...
	wire          hex_s1_agent_rp_valid;                                                              // hex_s1_agent:rp_valid -> router_011:sink_valid
	wire  [104:0] hex_s1_agent_rp_data;                                                               // hex_s1_agent:rp_data -> router_011:sink_data
	wire          hex_s1_agent_rp_ready;                                                              // router_011:sink_ready -> hex_s1_agent:rp_ready
	wire          hex_s1_agent_rp_startofpacket;                                                      // hex_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          hex_s1_agent_rp_endofpacket;                                                        // hex_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire  [104:0] ledr_s1_agent_rp_data;                                                              // ledr_s1_agent:rp_data -> router_012:sink_data
	...
	wire          hex_s1_agent_rdata_fifo_src_valid;                                                  // hex_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] hex_s1_agent_rdata_fifo_src_data;                                                   // hex_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          hex_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_009:in_0_ready -> hex_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_009_out_0_valid;                                                  // avalon_st_adapter_009:out_0_valid -> hex_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                                   // avalon_st_adapter_009:out_0_data -> hex_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                                  // hex_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                                  // avalon_st_adapter_009:out_0_error -> hex_s1_agent:rdata_fifo_sink_error
	...
	DE10_LITE_Qsys_mm_interconnect_0_router_002 router_011 (
	...
	DE10_LITE_Qsys_mm_interconnect_0_router_002 router_012 (
	...
	DE10_LITE_Qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (altpll_0_c0_clk),                                //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_LITE_Qsys_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (altpll_0_c0_clk),                                //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
